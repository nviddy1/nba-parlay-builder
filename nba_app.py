...
from nba_api.stats.endpoints import boxscorefourfactorsv2, leaguedashteamstats  
...
def get_efficiency_metrics(team_logs, n=10):
    ...
    for gid in recent['GAME_ID'].unique()[:n]:  # Limit for speed
        try:
            bsff = boxscorefourfactorsv2.BoxScoreFourFactorsV2(game_id=str(gid)).get_data_frames()[0]  # Changed to v2 and PascalCase class
